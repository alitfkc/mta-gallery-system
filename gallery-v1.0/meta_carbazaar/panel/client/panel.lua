...
local function resource_start()
    ...
    -- Add Vehicle
    ---------------------------------------------
    dgs.add_btn = createButton(0.009,0.88,0.09,0.04,language[language_section][17],true)
    ------------------------------------------
    -- remove vehicle
    ---------------------------------------------
    dgs.rev_btn = createButton(0.115,0.88,0.09,0.04,language[language_section][18],true)
    ----------------------------------------
    -- sell to server
    ---------------------------------------
    dgs.sell_btn = createButton(0.22,0.88,0.09,0.04,language[language_section][19],true)
    ...
    column_3 =dgsGridListAddColumn( cars_list,language[language_section][7] , 0.13 )
    column_4 =dgsGridListAddColumn( cars_list,language[language_section][8] , 0.13 )
    column_5 =dgsGridListAddColumn( cars_list,language[language_section][24] , 0.13 )
    column_6 =dgsGridListAddColumn( cars_list,language[language_section][9] , 0.13 )
    ...
    ----------------------------------------------------------
    vehicle_add_rev_panel = dgsCreateWindow(0.4,0.4,0.3,0.15,panel_name,true,tocolor(255,255,255),45,title_rect,false,false,tocolor(12,12,12,200),false,true)
    ...
    --write id ( - id yazma - )
    --------------------------------------------
    id_label = dgsCreateLabel(0.04,0.14,0.2,0.25,language[language_section][9],true,vehicle_add_rev_panel,false,1.4,1.4)
    ...
    ------------------------------------------
    price_label = dgsCreateLabel(0.28,0.14,0.2,0.25,language[language_section][7],true,vehicle_add_rev_panel,false,1.4,1.4)
    ...
    -------------------------------------
    dgs.approval_btn = createButton(0.52,0.3,0.2,0.25,language[language_section][20],true,vehicle_add_rev_panel)
    dgs.close_btn = createButton(0.76,0.3,0.2,0.25,language[language_section][13],true,vehicle_add_rev_panel)
